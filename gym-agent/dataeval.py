...
plt.xlabel('Epizoda [/]', fontsize=18)
plt.ylabel('Nagrada epizode [/]', fontsize=18)
...
# plt.plot(loss_s)
plt.xlabel('Epizoda [/]', fontsize=18)
plt.ylabel('Vrednost kriterijske funkcije [/]', fontsize=18)
plt.xlim([0, no_episodes])
plt.xticks(fontsize=18)
plt.yticks(fontsize=18)
plt.grid()
...
plt.plot(mean_q)
plt.xlabel('Epizoda [/]', fontsize=18)
plt.ylabel('Srednje Q-vrednosti [/]', fontsize=18)
